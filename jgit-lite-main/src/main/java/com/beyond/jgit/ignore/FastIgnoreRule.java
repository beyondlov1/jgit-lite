...
import com.beyond.jgit.ignore.internal.PathMatcher;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

import java.text.MessageFormat;

import static com.beyond.jgit.ignore.IMatcher.NO_MATCH;
import static com.beyond.jgit.ignore.internal.Strings.*;
...
public class FastIgnoreRule {
	...
	public FastIgnoreRule(String pattern) {
		...
		try {
			...
			LOG.error(MessageFormat.format("badIgnorePattern error", e));
		}
	}
